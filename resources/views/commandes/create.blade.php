        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('commandes.store') }}" class="space-y-6">
                ...
                <section class="bg-white rounded-2xl border border-stade-950/5 shadow-sm p-6 sm:p-8">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-text-input id="modele_maillot" name="modele_maillot" type="text" value="{{ old('modele_maillot') }}"
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="quantite" name="quantite" type="number" min="1" value="{{ old('quantite', 1) }}"
                            ...
                            <div class="flex items-end pb-2.5">
                                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                                    ...
                                    <input type="checkbox" name="badge" value="1" @checked(old('badge'))
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="personnalisation_nom" name="personnalisation_nom" type="text" value="{{ old('personnalisation_nom') }}"
                            ...
                            <div>
                                ...
                                <x-text-input id="personnalisation_numero" name="personnalisation_numero" type="text" value="{{ old('personnalisation_numero') }}"
                ...
                <section class="bg-white rounded-2xl border border-stade-950/5 shadow-sm p-6 sm:p-8">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" disabled value="{{ $referenceProchaine }}"
                                class="mt-1 block w-full border bg-stade-950/[0.03] border-stade-700/15 text-stade-600 rounded-lg shadow-sm py-2.5" />
                            <p class="mt-1 text-xs text-stade-600/70">Générée automatiquement à l'enregistrement.</p>
                        </div>

                        <div>
                            <x-input-label for="statut" value="Statut initial" />
                            <select id="statut" name="statut"
                                ...
                                @foreach(\App\Models\Commande::STATUTS as $valeur => $label)
                                    <option value="{{ $valeur }}" @selected(old('statut', 'en_attente') === $valeur)>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="date_commande" name="date_commande" type="date" value="{{ old('date_commande', now()->toDateString()) }}"
                            ...
                            <div>
                                ...
                                <x-text-input id="date_livraison_prevue" name="date_livraison_prevue" type="date"
                                    min="{{ now()->toDateString() }}" value="{{ old('date_livraison_prevue') }}"
                ...
                <div class="flex items-center justify-end gap-4">
                    <a href="{{ route('commandes.index') }}" class="text-sm font-semibold text-stade-600 hover:text-stade-950 transition">
                        Annuler
                    </a>
